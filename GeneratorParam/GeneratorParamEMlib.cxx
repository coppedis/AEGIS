...
#include "GeneratorParamEMlib.h"

ClassImp(GeneratorParamEMlib)

//Initializers for static members
Int_t GeneratorParamEMlib::fgSelectedCollisionsSystem=GeneratorParamEMlib::kpp7TeV;
Int_t GeneratorParamEMlib::fgSelectedPtParamPi0=GeneratorParamEMlib::kPizeroParam;
Int_t GeneratorParamEMlib::fgSelectedPtParamEta=GeneratorParamEMlib::kEtaParamRatiopp;
Int_t GeneratorParamEMlib::fgSelectedPtParamOmega=GeneratorParamEMlib::kOmegaParampp;
Int_t GeneratorParamEMlib::fgSelectedPtParamPhi=GeneratorParamEMlib::kPhiParampp;
Int_t GeneratorParamEMlib::fgSelectedCentrality=GeneratorParamEMlib::kpp;
Int_t GeneratorParamEMlib::fgSelectedV2Systematic=GeneratorParamEMlib::kNoV2Sys;

Double_t GeneratorParamEMlib::CrossOverLc(double a, double b, double x){
  if(x<b-a/2) return 1.0;
  else if(x>b+a/2) return 0.0;
  else return cos(((x-b)/a+0.5)*TMath::Pi())/2+0.5;
}

Double_t GeneratorParamEMlib::CrossOverRc(double a, double b, double x){
  return 1-CrossOverLc(a,b,x);
}

// const Double_t GeneratorParamEMlib::fgkV2param[kCentralities][16] = {
...
const Double_t GeneratorParamEMlib::fgkRawPtOfV2Param[kCentralities][10] = {
...
const Double_t GeneratorParamEMlib::fgkPtParam[kCentralities][10] = {
  {  0.0000000000, 0.0000000000, 0.0000000000, 0.0000000000,-1.0000000000, 1.0000000000,-1.0000000000, 1.0000000000, 0.0000000000, 0.0000000000 } // pp no V2
...
const Double_t GeneratorParamEMlib::fgkThermPtParam[kCentralities][2] = {
...
const Double_t GeneratorParamEMlib::fgkModTsallisParamPi0PbPb[kCentralities][7] = {
  {0.,   0.,   0.,   0.,   0.,   0.,   0.   }, // pp
  {0.,   0.,   0.,   0.,   0.,   0.,   0.   }, // 0-5
  {0.,   0.,   0.,   0.,   0.,   0.,   0.   }, // 5-10
...
const Double_t GeneratorParamEMlib::fgkModTsallisParamPiChargedPbPb[kCentralities][7] = {
  {0.,   0.,   0.,   0.,   0.,   0.,   0.   }, // pp
  {0.,   0.,   0.,   0.,   0.,   0.,   0.   }, // 0-5
  {0.,   0.,   0.,   0.,   0.,   0.,   0.   }, // 5-10
...
const Double_t GeneratorParamEMlib::fgkParamSetPi07TeV[kNPi0Param][7] = {
...
const Double_t GeneratorParamEMlib::fgkParamSetPi02760GeV[kNPi0Param][7] = {
...
const Double_t GeneratorParamEMlib::fgkParamSetPi0900GeV[kNPi0Param][7] = {
...
const Double_t GeneratorParamEMlib::fgkHM[16] = {0.1349766, 0.547853, 0.77549, 0.78265, 0.95778, 1.019455, 3.096916, 1.192642, 0.497614, 1.2311, 1.2349, 1.2349, 1.23340, 0.77549, 0.77549, 0.896};

const Double_t GeneratorParamEMlib::fgkMtFactor[3][16] = {
...
//
//--------------------------------------------------------------------------
Double_t GeneratorParamEMlib::PtModifiedHagedornThermal(Double_t pt,
                                                Double_t c,
                                                Double_t p0,
                                                Double_t p1,
                                                Double_t n,
...
Double_t GeneratorParamEMlib::PtModifiedHagedornExp(Double_t pt,
                                            Double_t c,
                                            Double_t p1,
                                            Double_t p2,
                                            Double_t p0,
...
Double_t GeneratorParamEMlib::PtModifiedHagedornExp2(Double_t pt,
                                             Double_t c,
                                             Double_t a,
                                             Double_t b,
                                             Double_t p0,
...
Double_t GeneratorParamEMlib::PtTsallis(Double_t pt,
                                Double_t m,
                                Double_t c,
                                Double_t T,
                                Double_t n)
...
Double_t GeneratorParamEMlib::PtXQCD( Double_t pt,
                              Double_t a,
                              Double_t b,
                              Double_t c,
                              Double_t d,
...
Double_t GeneratorParamEMlib::PtQCD(  Double_t pt,
                              Double_t a,
                              Double_t b,
                              Double_t c,
                              Double_t d,
...
Double_t GeneratorParamEMlib::PtModTsallis( Double_t pt,
                                    Double_t a,
                                    Double_t b,
                                    Double_t c,
                                    Double_t d,
...
Double_t GeneratorParamEMlib::PtParticleRatiopp(Double_t pt,
                                        Double_t m1,
                                        Double_t m2,
                                        Double_t c1,
                                        Double_t c2,
...
// Exponential
Double_t GeneratorParamEMlib::PtExponential(const Double_t *px, const Double_t *c){
...
Double_t GeneratorParamEMlib::PtModifiedHagedornPowerlaw(const Double_t *px, const Double_t *c){
  const double &pt=px[0];
...
Double_t GeneratorParamEMlib::PtDoublePowerlaw(const Double_t *px, const Double_t *c){
  const double &pt=px[0];
...
Double_t GeneratorParamEMlib::IntegratedKrollWada(const Double_t *mh, const Double_t *){
...
//
//--------------------------------------------------------------------------
Double_t GeneratorParamEMlib::PtPromptRealGamma( const Double_t *px, const Double_t */*dummy*/ )
{
...
Double_t GeneratorParamEMlib::PtThermalRealGamma( const Double_t *px, const Double_t */*dummy*/ )
{
  return PtExponential(px,fgkThermPtParam[fgSelectedCentrality]);
}

Double_t GeneratorParamEMlib::PtDirectRealGamma( const Double_t *px, const Double_t */*dummy*/ )
{
  return PtPromptRealGamma(px,px)+PtThermalRealGamma(px,px);
}

Int_t GeneratorParamEMlib::IpDirectRealGamma(TRandom *)
{
  return 220000;
}

Double_t GeneratorParamEMlib::YDirectRealGamma( const Double_t *px, const Double_t */*dummy*/ )
{
  return YFlat(*px);
}

Double_t GeneratorParamEMlib::V2DirectRealGamma( const Double_t *px, const Double_t */*dummy*/ )
{
...
//
//--------------------------------------------------------------------------
Double_t GeneratorParamEMlib::PtPromptVirtGamma( const Double_t *px, const Double_t */*dummy*/ )
{
  return IntegratedKrollWada(px,px)*PtPromptRealGamma(px,px);
}

Double_t GeneratorParamEMlib::PtThermalVirtGamma( const Double_t *px, const Double_t */*dummy*/ )
{
  return IntegratedKrollWada(px,px)*PtThermalRealGamma(px,px);
}

Double_t GeneratorParamEMlib::PtDirectVirtGamma( const Double_t *px, const Double_t */*dummy*/ )
{
  return IntegratedKrollWada(px,px)*PtDirectRealGamma(px,px);
}

Int_t GeneratorParamEMlib::IpDirectVirtGamma(TRandom *)
{
  return 220001;
}

Double_t GeneratorParamEMlib::YDirectVirtGamma( const Double_t *px, const Double_t */*dummy*/ )
{
  return YFlat(*px);
}

Double_t GeneratorParamEMlib::V2DirectVirtGamma( const Double_t *px, const Double_t */*dummy*/ )
{
...
//
//--------------------------------------------------------------------------
Int_t GeneratorParamEMlib::IpPizero(TRandom *)
{
  // Return pizero pdg code
  return 111;
}

Double_t GeneratorParamEMlib::PtPizero( const Double_t *px, const Double_t */*dummy*/ )
{
...
//   std::cout << "parametrisation: " << fgSelectedPtParamPi0 << std::endl;
  ...
  switch(fgSelectedCollisionsSystem) {
    ...
    default:
      ...
      printf("ERROR:: No valid collision system defined: %d \n",fgSelectedCollisionsSystem);
      return 0;
  }

}

Double_t GeneratorParamEMlib::YPizero( const Double_t *py, const Double_t */*dummy*/ )
{
  return YFlat(*py);

}

Double_t GeneratorParamEMlib::V2Pizero( const Double_t *px, const Double_t */*dummy*/ )
{
...
//
//--------------------------------------------------------------------------
Int_t GeneratorParamEMlib::IpEta(TRandom *)
{
  // Return eta pdg code
  return 221;     
}

Double_t GeneratorParamEMlib::PtEta( const Double_t *px, const Double_t */*dummy*/ )
{
...
Double_t GeneratorParamEMlib::YEta( const Double_t *py, const Double_t */*dummy*/ )
{
  return YFlat(*py);
}

Double_t GeneratorParamEMlib::V2Eta( const Double_t *px, const Double_t */*dummy*/ )
{
...
//
//--------------------------------------------------------------------------
Int_t GeneratorParamEMlib::IpRho0(TRandom *)
{
  // Return rho pdg code
  return 113;
}

Double_t GeneratorParamEMlib::PtRho0( const Double_t *px, const Double_t */*dummy*/ )
{
  // Rho pT
  return MtScal(*px,kRho0);
}

Double_t GeneratorParamEMlib::YRho0( const Double_t *py, const Double_t */*dummy*/ )
{
  return YFlat(*py);
}

Double_t GeneratorParamEMlib::V2Rho0( const Double_t *px, const Double_t */*dummy*/ )
{
...
//
//--------------------------------------------------------------------------
Int_t GeneratorParamEMlib::IpOmega(TRandom *)
{
  // Return omega pdg code
  return 223;
}

Double_t GeneratorParamEMlib::PtOmega( const Double_t *px, const Double_t */*dummy*/ )
{
  // Omega pT
...
Double_t GeneratorParamEMlib::YOmega( const Double_t *py, const Double_t */*dummy*/ )
{
  return YFlat(*py);
}

Double_t GeneratorParamEMlib::V2Omega( const Double_t *px, const Double_t */*dummy*/ )
{
...
//
//--------------------------------------------------------------------------
Int_t GeneratorParamEMlib::IpEtaprime(TRandom *)
{
  // Return etaprime pdg code
  return 331;
}

Double_t GeneratorParamEMlib::PtEtaprime( const Double_t *px, const Double_t */*dummy*/ )
{
  // Eta pT
  return MtScal(*px,kEtaprime);
}

Double_t GeneratorParamEMlib::YEtaprime( const Double_t *py, const Double_t */*dummy*/ )
{
  return YFlat(*py);

}

Double_t GeneratorParamEMlib::V2Etaprime( const Double_t *px, const Double_t */*dummy*/ )
{
...
//
//--------------------------------------------------------------------------
Int_t GeneratorParamEMlib::IpPhi(TRandom *)
{
  // Return phi pdg code
  return 333;
}

Double_t GeneratorParamEMlib::PtPhi( const Double_t *px, const Double_t */*dummy*/ )
{
  // Phi pT
...
Double_t GeneratorParamEMlib::YPhi( const Double_t *py, const Double_t */*dummy*/ )
{
  return YFlat(*py);
}

Double_t GeneratorParamEMlib::V2Phi( const Double_t *px, const Double_t */*dummy*/ )
{
...
//
//--------------------------------------------------------------------------
Int_t GeneratorParamEMlib::IpJpsi(TRandom *)
{
  // Return jpsi pdg code
  return 443;
}

Double_t GeneratorParamEMlib::PtJpsi( const Double_t *px, const Double_t */*dummy*/ )
{
  // Jpsi pT
...
Double_t GeneratorParamEMlib::YJpsi( const Double_t *py, const Double_t */*dummy*/ )
{
  return YFlat(*py);
}

Double_t GeneratorParamEMlib::V2Jpsi( const Double_t *px, const Double_t */*dummy*/ )
{
...
//
//--------------------------------------------------------------------------
Int_t GeneratorParamEMlib::IpSigma(TRandom *)
{
  // Return Sigma pdg code
  return 3212;     
}

Double_t GeneratorParamEMlib::PtSigma( const Double_t *px, const Double_t */*dummy*/ )
{
  // Sigma pT
  return MtScal(*px,kSigma0);
}

Double_t GeneratorParamEMlib::YSigma( const Double_t *py, const Double_t */*dummy*/ )
{
  return YFlat(*py);

}

Double_t GeneratorParamEMlib::V2Sigma0( const Double_t *px, const Double_t */*dummy*/ )
{
...
Int_t GeneratorParamEMlib::IpK0short(TRandom *)
{
  // Return kzeroshort pdg code
  return 310;
}

Double_t GeneratorParamEMlib::PtK0short( const Double_t *px, const Double_t */*dummy*/ )
{
  // K0short pT
...
Double_t GeneratorParamEMlib::YK0short( const Double_t *py, const Double_t */*dummy*/ )
{
  return YFlat(*py);

}

Double_t GeneratorParamEMlib::V2K0sshort( const Double_t *px, const Double_t */*dummy*/ )
{
...
//
//--------------------------------------------------------------------------
Int_t GeneratorParamEMlib::IpDeltaPlPl(TRandom *)
{
  // Return Delta++ pdg code
  return 2224;     
}

Double_t GeneratorParamEMlib::PtDeltaPlPl( const Double_t *px, const Double_t */*dummy*/ )
{
  // Delta++ pT
  return MtScal(*px,kDeltaPlPl);
}

Double_t GeneratorParamEMlib::YDeltaPlPl( const Double_t *py, const Double_t */*dummy*/ )
{
  return YFlat(*py);

}

Double_t GeneratorParamEMlib::V2DeltaPlPl( const Double_t *px, const Double_t */*dummy*/ )
{
...
//
//--------------------------------------------------------------------------
Int_t GeneratorParamEMlib::IpDeltaPl(TRandom *)
{
  // Return Delta+ pdg code
  return 2214;     
}

Double_t GeneratorParamEMlib::PtDeltaPl( const Double_t *px, const Double_t */*dummy*/ )
{
  // Delta+ pT
  return MtScal(*px,kDeltaPl);
}

Double_t GeneratorParamEMlib::YDeltaPl( const Double_t *py, const Double_t */*dummy*/ )
{
  return YFlat(*py);

}

Double_t GeneratorParamEMlib::V2DeltaPl( const Double_t *px, const Double_t */*dummy*/ )
{
...
//
//--------------------------------------------------------------------------
Int_t GeneratorParamEMlib::IpDeltaMi(TRandom *)
{
  // Return Delta- pdg code
  return 1114;     
}

Double_t GeneratorParamEMlib::PtDeltaMi( const Double_t *px, const Double_t */*dummy*/ )
{
  // Delta- pT
  return MtScal(*px,kDeltaMi);
}

Double_t GeneratorParamEMlib::YDeltaMi( const Double_t *py, const Double_t */*dummy*/ )
{
  return YFlat(*py);

}

Double_t GeneratorParamEMlib::V2DeltaMi( const Double_t *px, const Double_t */*dummy*/ )
{
...
//
//--------------------------------------------------------------------------
Int_t GeneratorParamEMlib::IpDeltaZero(TRandom *)
{
  // Return Delta0 pdg code
  return 2114;     
}

Double_t GeneratorParamEMlib::PtDeltaZero( const Double_t *px, const Double_t */*dummy*/ )
{
  // Delta0 pT
  return MtScal(*px,kDeltaZero);
}

Double_t GeneratorParamEMlib::YDeltaZero( const Double_t *py, const Double_t */*dummy*/ )
{
  return YFlat(*py);

}

Double_t GeneratorParamEMlib::V2DeltaZero( const Double_t *px, const Double_t */*dummy*/ )
{
...
//
//--------------------------------------------------------------------------
Int_t GeneratorParamEMlib::IpRhoPl(TRandom *)
{
  // Return rho+ pdg code
  return 213;     
}

Double_t GeneratorParamEMlib::PtRhoPl( const Double_t *px, const Double_t */*dummy*/ )
{
  // rho + pT
  return MtScal(*px,kRhoPl);
}

Double_t GeneratorParamEMlib::YRhoPl( const Double_t *py, const Double_t */*dummy*/ )
{
  return YFlat(*py);

}

Double_t GeneratorParamEMlib::V2RhoPl( const Double_t *px, const Double_t */*dummy*/ )
{
...
//
//--------------------------------------------------------------------------
Int_t GeneratorParamEMlib::IpRhoMi(TRandom *)
{
  // Return rho- pdg code
  return -213;     
}

Double_t GeneratorParamEMlib::PtRhoMi( const Double_t *px, const Double_t */*dummy*/ )
{
  // rho- pT
  return MtScal(*px,kRhoMi);
}

Double_t GeneratorParamEMlib::YRhoMi( const Double_t *py, const Double_t */*dummy*/ )
{
  return YFlat(*py);

}

Double_t GeneratorParamEMlib::V2RhoMi( const Double_t *px, const Double_t */*dummy*/ )
{
...
//
//--------------------------------------------------------------------------
Int_t GeneratorParamEMlib::IpK0star(TRandom *)
{
  // Return K0 * pdg code
  return 313;     
}

Double_t GeneratorParamEMlib::PtK0star( const Double_t *px, const Double_t */*dummy*/ )
{
  // K0 * pT
  return MtScal(*px,kK0star);
}

Double_t GeneratorParamEMlib::YK0star( const Double_t *py, const Double_t */*dummy*/ )
{
  return YFlat(*py);

}

Double_t GeneratorParamEMlib::V2K0star( const Double_t *px, const Double_t */*dummy*/ )
{
...
Double_t GeneratorParamEMlib::YFlat(Double_t /*y*/)
{
  //--------------------------------------------------------------------------
  //
...
//============================================================= 
//
Double_t GeneratorParamEMlib::MtScal(Double_t pt, Int_t np)
{
  ...
  switch (fgSelectedCollisionsSystem){
    ...
    default:
      selectedCol=0;
      printf("<GeneratorParamEMlib::MtScal> no collision system has been given\n");
  }
...
Double_t GeneratorParamEMlib::KEtScal(Double_t pt, Int_t np, Int_t nq)
{
...
Double_t GeneratorParamEMlib::V2Param(const Double_t *px, const Double_t *par)
{
...
Double_t GeneratorParamEMlib::V2Flat(const Double_t */*px*/, const Double_t */*param*/)
{
  // Flat v2
...
Double_t GeneratorParamEMlib::GetTAA(Int_t cent){
...
GenFunc GeneratorParamEMlib::GetPt(Int_t param, const char * tname) const
{
  ...
  switch (param) {
    ...
    default:
      func=0;
      printf("<GeneratorParamEMlib::GetPt> unknown parametrisation\n");
  }
  return func;
}

GenFunc GeneratorParamEMlib::GetY(Int_t param, const char * tname) const
{
  ...
  switch (param) {
    ...
    default:
      func=0;
      printf("<GeneratorParamEMlib::GetY> unknown parametrisation\n");
  }
  return func;
}

GenFuncIp GeneratorParamEMlib::GetIp(Int_t param, const char * tname) const
{
  ...
  switch (param) {
    ...
    default:
      func=0;
      printf("<GeneratorParamEMlib::GetIp> unknown parametrisation\n");
  }
  return func;
}

GenFunc GeneratorParamEMlib::GetV2(Int_t param, const char * tname) const
{
  ...
  switch (param) {
    ...
    default:
      func=0;
      printf("<GeneratorParamEMlib::GetV2> unknown parametrisation\n");
  }
  return func;
}
